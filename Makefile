...
SRCS = main.c tester.c syntax.c utils.c utils2.c utils3.c token_utils.c ft_quotes_split.c free_funcs.c type_check.c syntax2.c expand.c build_commands.c create_env.c redirections.c heredoc.c heredoc_utils.c\
